...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TfsScript* __fastcall fsGlobalUnit();
extern DELPHI_PACKAGE bool __fastcall fsIsGlobalUnitExist();
extern DELPHI_PACKAGE System::Classes::TList* __fastcall fsRTTIModules();
}	/* namespace Fs_iinterpreter */
